...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
	  <th width="34" class="title"><input type="checkbox" name="chkall" onClick="chkallClick(this);"></th>
		<th class="title"></th>	
		<th width="37" class="title"><a class="title" href="<?php echo getLinkSort(1); ?>">ID</a></th>
		<th width="311" class="title"><a class="title" href="<?php echo getLinkSort(3); ?>">Tên</a></th>
		<th width="103" class="title"><a class="title" href="<?php echo getLinkSort(6); ?>">Nội dung</a></th>
		<th width="73" class="title"><a class="title" href="<?php echo getLinkSort(10); ?>">Thứ tự sắp xếp</a></th>
		<th width="73" class="title"><a class="title" href="<?php echo getLinkSort(11); ?>">Không hiển thị</a></th>
		<th width="140" class="title"><a class="title" href="<?php echo getLinkSort(12); ?>">Ngày tạo lập</a></th>
		<th width="140" class="title"><a class="title" href="<?php echo getLinkSort(13); ?>">Lần hiệu chỉnh trước</a></th>
		<th width="75" class="title"><a class="title" href="<?php echo getLinkSort(14); ?>">Ngôn ngữ</a></th>
	</tr>
...
?>
	...
	<tr>
		...
		<td width="37" align="center" bgcolor="<?php echo $color; ?>" class="smallfont">
